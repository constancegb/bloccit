...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:my_sponsored_post) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 2) }
  ...
  describe "GET new" do
    ...
    it "instantiates @sponsored_post" do
      get :new, topic_id: my_topic.id
      expect(assigns(:sponsored_post)).not_to be_nil #assigns gives us access to the @post variable, assigning it to :post
    end
  end
